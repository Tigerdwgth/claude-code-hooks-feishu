...
import { TileType } from '../pixel-office/types.js'
import type { OfficeLayout, EditTool as EditToolType, TileType as TileTypeVal, FloorColor, PlacedFurniture } from '../pixel-office/types.js'
import { paintTile, placeFurniture, removeFurniture, moveFurniture, rotateFurniture, toggleFurnitureState, canPlaceFurniture, getWallPlacementRow, expandLayout } from '../pixel-office/editor/editorActions.js'
import type { ExpandDirection } from '../pixel-office/editor/editorActions.js'
import { getCatalogEntry, getRotatedType, getToggledType } from '../pixel-office/layout/furnitureCatalog.js'
import { defaultZoom } from '../pixel-office/toolUtils.js'
import { vscode } from '../pixel-vscodeApi.js'
import { LAYOUT_SAVE_DEBOUNCE_MS, ZOOM_MIN, ZOOM_MAX } from '../pixel-constants.js'
